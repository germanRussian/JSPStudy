...
<%!public void updateLoc(Connection conn, PreparedStatement stmt, String uid, String lat, String lon) {
	...
	public void createLoc(Connection conn, PreparedStatement stmt, String uid, String lat, String lon) {
		try {
			String sql = "insert into g_location values(?,?,?)";
			stmt = conn.prepareStatement(sql);
...
<body class="page06">
	<div class="busmap">
		...
		<script type="text/javascript"
			src="//dapi.kakao.com/v2/maps/sdk.js?appkey=304515de9a793cbb128ff4d43e065c74"></script>


		<script>
			var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
			mapOption = {
				center : new kakao.maps.LatLng(lat, lon), // 지도의 중심좌표, 처음의 위치 설정
				level : 5
			// 지도의 확대 레벨
			};
...
%>	
    {
        ...
        latlng: new kakao.maps.LatLng(<%=rs.getString("lat") %>, <%=rs.getString("lon") %>)
    },
<%
	}
	} catch(Exception e){
